...
Après la traduction, présente les principaux Méfarchim permettant de comprendre cette Michna.
...
Ne force pas la présence d'un auteur.

Donne entre 2 et 5 commentaires lorsqu'ils existent réellement.
